...
In previous articles, we introduced [<u>**the open-source spirit of PrivyDrop**</u>](/blog/privydrop-open-source) and the core technology behind it, [<u>**WebRTC**</u>](/blog/webrtc-file-transfer). We successfully created a secure and private file-sharing tool based on peer-to-peer (P2P) technology.
