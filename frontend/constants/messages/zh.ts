...
export const zh: Messages = {
  meta: {
    home: {
      ...
      description:
        "PrivyDrop是一款开源、免费且安全的P2P文件传输工具，无大小限制，无需注册。基于WebRTC实现端到端加密，代码透明可信。支持文本、图片、文件夹跨设备分享，完美支持团队协作和私密文件传输。",
      keywords:
        "开源文件共享,P2P文件传输,安全文件传输,webrtc文件共享,私密剪贴板,源代码透明,GitHub项目,团队协作,跨设备共享,加密文件传输,免注册文件共享,无限制文件传输,文件夹同步,手机文件传输,安全通讯,即时文件共享,私密数据传输",
    },
    about: {
      title: "关于PrivyDrop",
      description:
