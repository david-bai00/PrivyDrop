...
export const ja: Messages = {
  meta: {
    home: {
      ...
      description: "PrivyDropは、サイズ制限や登録が不要な、オープンソースで無料の安全なP2Pファイル転送ツールです。WebRTCに基づいたエンドツーエンド暗号化により、コードは透明で信頼性があります。テキスト、画像、フォルダをデバイス間で共有し、チームコラボレーションやプライベートなファイル転送に最適です。",
      keywords: "オープンソースファイル共有,P2Pファイル転送,安全なファイル転送,webrtcファイル共有,プライベートクリップボード,ソースコードの透明性,GitHubプロジェクト,チームコラボレーション,クロスデバイス共有,暗号化ファイル転送,登録不要ファイル共有,無制限ファイル転送,フォルダ同期,モバイルファイル転送,安全なメッセージング,即時ファイル共有,プライベートデータ転送",
    },
    about: {
      title: "PrivyDropについて",
      description:
