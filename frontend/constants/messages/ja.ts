...
export const ja: Messages = {
  meta: {
    home: {
      title:
        "PrivyDrop: 無料P2Pファイル＆クリップボード共有 | プライベート＆アップロード不要",
      description:
        "PrivyDropは、サイズ制限や登録なしで即座に安全なP2Pファイル共有を可能にします。テキスト、画像、フォルダをエンドツーエンド暗号化でデバイス間で共有。チームコラボレーションやプライベートファイル転送に最適です。",
      keywords:
