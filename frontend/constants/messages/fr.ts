...
export const fr: Messages = {
  ...
  text: {
    ...
    about: {
      ...
      otherProjects: {
        title: "Autres outils que nous développons",
        description: "Nous développons aussi",
        linkLabel: "HandyXlate, un outil Android de traduction d'écran",
        trailingText:
          " pour le texte déjà visible à l'écran mais peu pratique à copier dans une autre application.",
      },
    },
    howItWorks: {
    ...
    clipboard: {
      ...
      join: {
        ...
        inProgress: "Rejoindre la salle… (sur un réseau lent, 5–30 s possibles)",
        slow: "C’est un peu lent — vérifiez votre réseau/VPN ou réessayez bientôt",
      ...
      rtc: {
        ...
        negotiating: "Dans la salle — établissement d’un lien P2P direct…",
        connected: "Connecté",
      ...
      cachedId: {
        save: "Enregistrer l’ID",
        use: "Utiliser l’ID en cache",
        saveTip: "Enregistrez l’ID actuel pour une réutilisation rapide",
