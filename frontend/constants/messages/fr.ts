...
export const fr: Messages = {
  meta: {
    home: {
      title:
        "SecureShare : Partage de fichiers et de presse-papiers P2P gratuit | Privé et sans téléchargement",
      description:
        "SecureShare permet un partage de fichiers P2P instantané et sécurisé sans limites de taille ni inscription. Partagez du texte, des images, des dossiers entre appareils avec un chiffrement de bout en bout. Parfait pour la collaboration d'équipe et le transfert de fichiers privés.",
      keywords:
    ...
    about: {
      ...
      description:
        "Découvrez SecureShare, notre mission de fournir un service de transfert de fichiers et de partage de presse-papiers sécurisé et privé, ainsi que notre engagement envers la protection de la vie privée et des données des utilisateurs.",
    },
    faq: {
      title: "FAQ de SecureShare",
      description:
        "Trouvez des réponses aux questions fréquemment posées sur SecureShare, y compris comment envoyer des fichiers, partager du contenu de presse-papiers et assurer des transferts de données sécurisés et privés.",
      keywords:
        "FAQ SecureShare, questions fréquemment posées, FAQ partage de fichiers sécurisé, aide au partage de données privées, transfert de fichiers chiffré de bout en bout, support de partage de presse-papiers sécurisé, comment utiliser SecureShare, FAQ transfert de fichiers, questions sur le partage axé sur la confidentialité, dépannage SecureShare",
    },
    help: {
      title: "Aide et support de SecureShare",
      description:
        "Trouvez des informations sur la façon de contacter le support de SecureShare, ainsi que des liens vers nos pages À propos, Conditions d'utilisation et Politique de confidentialité pour plus de détails sur notre service.",
    },
    privacy: {
      title: "Politique de confidentialité de SecureShare",
      description:
        "Comprenez comment SecureShare protège votre vie privée et vos données, y compris des détails sur la collecte d'informations, le stockage et la sécurité des données, ainsi que notre engagement à ne pas partager vos données avec des tiers.",
    },
    terms: {
      title: "Conditions d'utilisation de SecureShare",
      description:
        "Consultez les conditions d'utilisation de SecureShare, y compris des informations sur l'utilisation acceptable du service, la confidentialité et la sécurité des données, ainsi que les limitations de responsabilité.",
    },
  },
  text: {
    Header: {
    ...
    privacy: {
      ...
      h2_3: "Services tiers",
      h2_3_P:
        "SecureShare n'intègre aucun service ou plateforme tiers. Nous ne partageons ni ne vendons vos données à des tiers.",
    ...
    terms: {
      ...
      h2_1_P:
        "SecureShare est fourni comme un service gratuit sans aucune restriction.",
      ...
      h2_3_P:
        "Vous acceptez de ne pas utiliser SecureShare à des fins illégales, abusives ou nuisibles. Cela inclut, mais sans s'y limiter, le transfert de contenu illégal, protégé par le droit d'auteur ou malveillant, ainsi que l'utilisation du service pour harceler ou usurper l'identité d'autrui.",
      h2_4: "Limitation de responsabilité",
      h2_4_P:
        "SecureShare est fourni « tel quel » sans aucune garantie. Nous ne serons pas responsables des dommages directs, indirects ou consécutifs résultant de l'utilisation de notre service, y compris, mais sans s'y limiter, la perte de données, les défaillances du système ou les interruptions de service.",
    ...
    help: {
      ...
      h2_3_P:
        "Pour plus d'informations sur SecureShare, consultez les pages suivantes :",
    },
    about: {
    ...
    faqs: {
      ...
      question_5:
        "Mes données sont-elles sécurisées lorsque j'utilise SecureShare ?",
      answer_5:
      ...
      answer_10:
        "Non, SecureShare est conçu pour être léger et efficace. Si vous définissez un répertoire de sauvegarde, toutes les données reçues sont écrites directement sur le disque, contournant la mémoire, ce qui aide à maintenir les performances de votre appareil.",
