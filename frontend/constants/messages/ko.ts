...
export const ko: Messages = {
  meta: {
    home: {
      title:
        "PrivyDrop: 무료 P2P 파일 및 클립보드 공유 | 개인 정보 보호 및 업로드 없음",
      description:
        "PrivyDrop는 크기 제한 없이, 등록 없이 즉각적이고 안전한 P2P 파일 공유를 가능하게 합니다. 텍스트, 이미지, 폴더를 기기 간에 엔드투엔드 암호화로 공유하세요. 팀 협업 및 개인 파일 전송에 완벽합니다.",
      keywords:
