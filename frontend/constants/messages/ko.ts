...
export const ko: Messages = {
  meta: {
    home: {
      title:
        "SecureShare: 무료 P2P 파일 및 클립보드 공유 | 개인 정보 보호 및 업로드 없음",
      description:
        "SecureShare는 크기 제한 없이, 등록 없이 즉각적이고 안전한 P2P 파일 공유를 가능하게 합니다. 텍스트, 이미지, 폴더를 기기 간에 엔드투엔드 암호화로 공유하세요. 팀 협업 및 개인 파일 전송에 완벽합니다.",
      keywords:
        "파일 공유, 안전한 파일 전송, P2P 파일 전송, WebRTC 파일 공유, 개인 클립보드, 팀 협업, 기기 간 공유, 암호화 파일 전송, 등록 없는 파일 공유, 무제한 파일 전송, 폴더 동기화, 모바일 파일 전송, 안전한 메시징, 즉각적인 파일 공유, 개인 데이터 전송",
    },
    about: {
      title: "SecureShare 소개",
      description:
        "SecureShare에 대해 알아보세요. 우리는 안전하고 개인적인 파일 전송 및 클립보드 공유 서비스를 제공하기 위해 노력하며, 사용자의 개인 정보와 데이터 보호를 최우선으로 합니다.",
    },
    faq: {
      title: "SecureShare FAQ",
      description:
        "SecureShare에 대해 자주 묻는 질문에 대한 답변을 찾아보세요. 파일을 보내는 방법, 클립보드 콘텐츠를 공유하는 방법, 안전하고 개인적인 데이터 전송을 보장하는 방법 등을 포함합니다.",
      keywords:
        "SecureShare FAQ, 자주 묻는 질문, 안전한 파일 공유 FAQ, 개인 데이터 공유 도움말, 엔드투엔드 암호화 파일 전송, 안전한 클립보드 공유 지원, SecureShare 사용 방법, 파일 전송 FAQ, 개인 정보 보호 중심 공유 질문, SecureShare 문제 해결",
    },
    help: {
      title: "SecureShare 도움말 및 지원",
      description:
        "SecureShare 지원팀에 문의하는 방법에 대한 정보와 서비스에 대한 자세한 내용을 확인할 수 있는 소개, 이용 약관 및 개인정보 보호정책 페이지 링크를 찾아보세요.",
    },
    privacy: {
      title: "SecureShare 개인정보 보호정책",
      description:
        "SecureShare가 어떻게 귀하의 개인 정보와 데이터를 보호하는지 이해하세요. 정보 수집, 데이터 저장 및 보안에 대한 세부 사항과 제3자와 데이터를 공유하지 않겠다는 우리의 약속을 포함합니다.",
    },
    terms: {
      title: "SecureShare 이용 약관",
      description:
        "SecureShare의 이용 약관을 검토하세요. 서비스의 허용 가능한 사용, 데이터 개인 정보 보호 및 보안, 책임 제한에 대한 정보를 포함합니다.",
    },
  },
  text: {
    Header: {
    ...
    privacy: {
      ...
      h2_1: "정보 수집",
      h2_1_P:
        "SecureShare는 사용자로부터 개인 식별 정보를 수집하지 않습니다. 우리 서비스를 사용하기 위해 등록이나 계정 생성이 필요하지 않습니다. 우리가 수집하는 유일한 정보는 방 ID와 귀하가 다른 사용자와 공유하기로 선택한 파일/클립보드 데이터입니다.",
      h2_2: "데이터 저장 및 보안",
      h2_2_P:
      ...
      h2_3: "제3자 서비스",
      h2_3_P:
        "SecureShare는 제3자 서비스나 플랫폼과 통합되지 않습니다. 우리는 귀하의 데이터를 제3자와 공유하거나 판매하지 않습니다.",
      h2_4: "개인정보 보호정책 변경",
      h2_4_P:
    ...
    terms: {
      ...
      h2_3: "허용 가능한 사용",
      h2_3_P:
        "귀하는 SecureShare를 불법적, 남용적 또는 유해한 목적으로 사용하지 않기로 동의합니다. 이는 불법적, 저작권이 있는 또는 악성 콘텐츠의 전송 및 타인을 괴롭히거나 사칭하기 위해 서비스를 사용하는 것을 포함하되 이에 국한되지 않습니다.",
      h2_4: "책임 제한",
      h2_4_P:
        "SecureShare는 어떠한 보증도 없이 '있는 그대로' 제공됩니다. 우리는 데이터 손실, 시스템 오류 또는 서비스 중단을 포함하되 이에 국한되지 않는 서비스 사용으로 인한 직접적, 간접적 또는 결과적 손해에 대해 책임을 지지 않습니다.",
      h2_5: "이용 약관 변경",
      h2_5_P:
    ...
    faqs: {
      ...
      answer_10:
        "아니요, SecureShare는 가볍고 효율적으로 설계되었습니다. 저장 디렉토리를 설정하면 모든 수신 데이터는 메모리를 우회하여 직접 디스크에 기록되므로 기기 성능을 유지하는 데 도움이 됩니다.",
